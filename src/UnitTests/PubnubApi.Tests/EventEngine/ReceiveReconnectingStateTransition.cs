...
namespace PubnubApi.Tests.EventEngine
{
    internal class ReceiveReconnectingStateTransition
    {
        ...
        public void ReceiveReconnectingState_OnReceiveReconnectGiveupEvent_TransitionToReceiveFailedState()
        {
            ...
            //Assert
            ClassicAssert.IsInstanceOf<ReceiveFailedState>(result.State);
            ...
            ClassicAssert.AreEqual(expectedState.Cursor.Region, ((ReceiveFailedState)result.State).Cursor.Region);
            ClassicAssert.AreEqual(expectedState.Cursor.Timetoken, ((ReceiveFailedState)result.State).Cursor.Timetoken);
            ClassicAssert.IsInstanceOf<EmitStatusInvocation>(result.Invocations.ElementAt(0));
